...
public class SystemManagementApp {
    ...
    public static void main(String[] args) {
        ...
        while (x > 1)
        {
            ...
            System.out.println("1 - Create/ Edit a Student, Faculty, Course, or Semester");
    ...
    public static void enrollStudent(Enrollment[] studentEnrollmentArray, int studentEnrollmentCount)
    {
        ...
        System.out.println("Please enter semester period:");
            ...
            int facultyCount, Course[] courseArray, int courseCount, Semester[] semesterArray, int semesterCount)
    {
        ...
        switch (selection)
        {
            ...
            case 1:
            System.out.print("What student would you like to edit (enter StudentID)?");
            int studentSelection = in.nextInt();
            in.nextLine();
            
            System.out.print("What data would like to edit?");
            ...
            switch (dataSelection)
            {
                ...
                case "Contacts":
                    ...
                    System.out.println("Do you want to edit emergency contact name, phone number or address (Select one: Name, Phone Number, Address)?");
           ...
           //case 2 handles changing a faculty members info. program prompts user for which data field they want to change and makes the necessary changes
            ...
            System.out.print("What faculty would you like to edit (enter facultyID)?");
            int facultySelection = in.nextInt();
            in.nextLine();
            
            System.out.print("What data would like to edit?");
            System.out.println("emplName, emplEmail, building, officeNum, emplPhone, dept, position (enter one option)");
            ...
            case 3:
                ...
                System.out.print("What course would you like to edit (enter courseID)?");
                int courseSelection = in.nextInt();
                in.nextLine();
            
                System.out.print("What data would like to edit?");
                System.out.println("courseID, prefix, courseNum, courseName, days, timeStart, timeEnd, creditHr (enter one option)");
            ...
            case 4:
                ...
                System.out.println("What would you like to edit (period, year)?");
